...
function create() {
  ...
  // Lahko nastavimo omejitve sveta, npr. od 0,0 do 1920,1920
  // Če objektom nastavimo setCollideWorldBounds(true) ne morejo uhajati izven omejitev sveta
  // Objektom igre lahko nastavimo tudi setBounce(x,y) da se od robov sveta odbijajo
  //this.physics.world.setBounds(0, 0, 1920, 1920);

  // Tudi kameri lahko nastavimo omejitev
...
function update() {
  ...
  // Ali je tipka, ki smo povedali, da nam pomeni akcijo pojdiNaprej pritisnjena (isDown)
  if (definiraneTipke.pojdiNaprej.isDown) {
    ...
    // Če ja pritisnjena tipka za nazaj, nastavimo hitrost premikanja v minus po osi x.
    arrow2.setVelocity(-200, 0);
  } else {
